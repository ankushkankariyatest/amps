(function () {
    "use strict";
    define(['assetIt', 'jquery','typeahead'], function (app, $) {
        app.register.directive('sfTypeahead', ['$location', function ($location) {
                return {
                    ...
                    link: function (scope, element, attrs, ngModel) {
                        ...
                        function updateScope(object, suggestion, dataset) {
                            ...
                            onSelection(suggestion, dataset);
                        }

                        var onSelection = function (suggestion, datasets) {
                            var _decisionMaker = {
                                apps: {
                                    location: '/applications/' + suggestion.APP_ID
                                },
                                mcps: {
                                    location: '/mcps/' + suggestion.CODE
                                },
                                lobs: {
                                    location: '/lobs/' + suggestion.LOB_NAME
                                }
                            }
                            var routeTo = _decisionMaker[datasets].location;
